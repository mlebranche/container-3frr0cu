...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-3frr0cu.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-3frr0cu.containers.anotherwebservice.com/
...
```
git clone git@github.com:mlebranche/container-3frr0cu.git
cd container-3frr0cu
```
...
```
docker attach container-3frr0cu
```
